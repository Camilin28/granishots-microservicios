...
import com.granishots.login.application.dto.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleDataIntegrity(DataIntegrityViolationException ex) {
        return ResponseEntity.badRequest().body(buildError(400, "El email ya está registrado en el sistema", null));
    }
